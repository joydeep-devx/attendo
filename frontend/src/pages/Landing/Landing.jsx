                ...
                <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
                    ...
                    >
                        ...
                        <h1 className="mt-4 font-display text-4xl leading-tight tracking-tight text-ink sm:text-5xl">
                            Timetables that build themselves and hold together
                        </h1>
                    ...
                    <div className="mt-8 grid gap-6 sm:grid-cols-3">
                        {ROLES.map((role, i) => (
                            <Reveal key={role.name} delay={i * 0.1}>
                                <div
                                    key={role.name}
                                    className="rounded-lg border border-line p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-indigo-soft hover:shadow-md"
                                >
