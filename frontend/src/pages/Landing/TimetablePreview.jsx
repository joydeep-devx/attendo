...
const STATUS = [
    {
        label: "Generating",
        text: "Placing classes across 5 working days",
        tone: "text-slate",
    },
    {
        label: "Conflict",
        text: "T001 is already teaching at WED 10:00",
        tone: "text-absent",
    },
    {
        label: "Resolved",
        text: "Moved to THU 09:00 — no clashes remain",
        tone: "text-present",
    },
];
...
function RobotHand({ grip }) {
    return (
        <svg
            viewBox="0 0 40 34"
            className="h-8 w-8 overflow-visible drop-shadow-sm"
        >
            <rect
                x="16"
                y="0"
        ...
        <div className="rounded-lg border border-line bg-paper-raised p-4">
            ...
            >
                ...
                {CLASSES.map((item, index) => (
                    ...
                    >
                        <span className="font-mono text-[11px] font-medium text-indigo-dark">
                            {item.code}
                        </span>
            ...
            <div className="mt-4 flex items-center gap-3 border-t border-line pt-3">
                <span
                    className={`font-mono text-[10px] uppercase tracking-wider ${status.tone}`}
                >
                    {status.label}
                </span>
